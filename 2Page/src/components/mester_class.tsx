...
export const MasterClass = () => {
  return (
    <div className="container">
      ...
      <div className="container bg-gray-100 p-4 py-12 sm:text-start text-center sm:p-16 flex flex-wrap sm:justify-between sm:items-end gap-20 flex-col sm:flex-row    rounded-3xl lg:w-lg hover:scale-110 transition-transform">
